<?php 
    ...
    $sql = "SELECT sucesos.fecha FROM sucesos, partos WHERE partos.fechaParto < DATE_SUB(sucesos.fecha, INTERVAL 21 DAY) AND sucesos.idanimal=partos.idParto AND sucesos.suceso = 'muerte'";
    $sentencia= $conexion->prepare($sql);
    $sentencia->execute();
    ...
    if(isset($_POST['fechaInicio'])){
        ...
        //desarrrollo y engorda 
        $sql = "SELECT sucesos.fecha FROM sucesos, partos WHERE partos.fechaParto < DATE_SUB(sucesos.fecha, INTERVAL 21 DAY) AND sucesos.idanimal=partos.idParto AND sucesos.suceso = 'muerte' AND sucesos.fecha BETWEEN '$inicio' AND '$fin'";
        $sentencia= $conexion->prepare($sql);
        $sentencia->execute();
